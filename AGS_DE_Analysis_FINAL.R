...
MaleTreatsig_orth = read.csv("Male_LHvsEH_sig.csv")
FemaleTreatsig_orth = read.csv("Female_LHvsEH_sig.csv")
twoWeekSexsig_orth = read.csv("earlyHib_MvsF_sig.csv")
lateHibSexsig_orth = read.csv("lateHib_MvsF_sig.csv")
